...
def main():
    ...
    medium3 = NewSteganography("files/mona_small_h.png")
    o = medium3.checkIfMessageExists()
    print (o)
    print (medium3.direction)
    '''
    ...
    def checkIfMessageExists(self):
        ...
        while(ia+2 < 100 and sp != "age>"):
            ...
            if len(mes) > 10:
                sp = mes[-4:]
        #print (mes)
        match = re.search(r"<\?xml.*",mes)
        m = re.search(r"<message type=\"(.*)\"\s*size",mes)
        if m:
            #print(m.group(1))
